...
## Events-Page hat kein Auto-Update
Wenn ein neuer Event hinzukommt, sollte sich auch die Event-Page updaten, bzw. der neue Event sichtbar werden. Wenn ich gerade einen Event ansehe (popup), dann bleibt der offen und im Hintergrund kommt einfach die neue Kachel hinzu.
