...
Lets kiosk users browse and review past person-detection events of the
cameras configured for the events page — who was seen, when, with a snapshot
and clip — without leaving the kiosk UI or opening Frigate's own interface.
